    ...
    vec![
        ...
        GuideSection {
            ...
            body: vec![
                ...
                "1 opens today's daily; 2 opens your replay board.".to_string(),
                "0 twice starts replay with a new random word.".to_string(),
                "Replay progress saves, but only the daily earns rewards.".to_string(),
